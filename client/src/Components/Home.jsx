...
const Home = () => {
  return (
    <div id='Home' className='w-full min-h-screen flex justify-center items-center text-center px-6'>
      ...
      <main>
        <h1 className='text:4xl md:text-4xl lg:text-5xl font-semibold tracking-wide'>Zaheer Ahmed S</h1>
        
        <p className='flex sm:flex-row justify-center items-center lg:gap-2 gap-1 text-lg font-light tracking-wide'>Software Developer

        <span className=' text-2xl font-bold'> • </span>Mern Stack Developer</p>
